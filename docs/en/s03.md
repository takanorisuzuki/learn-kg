---
title: "s03: The Problem RAG Can't Solve and the Rise of GraphRAG"
level: "beginner"
duration: 45
---

# s03: The Problem RAG Can't Solve and the Rise of GraphRAG

`[ s03 ] <- s02 What Is a Knowledge Graph? | s04 Set Up Neo4j and Run Your First GraphRAG ->`
...
```cypher
// A single KG query answers this
MATCH (company:Company {name: 'ABC Corp.'})
...
In s02, you learned the fundamentals of KG as a data model. In this session, you understand why integrating a KG into existing RAG systems is necessary.

| s02 | s03 |
|-----|-----|
| Learned what a KG is | Understood RAG's limitations and what KG can solve |
| Implemented KG with networkx | Can diagnose the 5 RAG failure patterns |
| Understood RDB vs. KG | Can make an informed judgment about moving to GraphRAG |
...
In the next session, you will set up Neo4j and run your first GraphRAG pipeline.
