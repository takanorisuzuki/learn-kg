...
- **s11** — Graph Traversal Contract: formalizing the rules for how agents read the KG
- **s12** — KG Adoption Strategy: a three-phase roadmap from local proof-of-concept to production
- **s13** — Measuring KG Projects: the evaluation cycle that makes improvement systematic
