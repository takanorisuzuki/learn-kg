---
title: "s05: Auto-Build a KG from Text with an LLM"
level: "beginner"
duration: 60
---

# s05: Auto-Build a KG from Text with an LLM

`[ s05 ] <- s04 Set Up Neo4j and Run Your First GraphRAG | s06 Production-Grade GraphRAG Pipeline ->`
